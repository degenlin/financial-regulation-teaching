...
P2P_PLATFORMS = [
    {
        ...
        "violations": [],
        "verdict": "合规",
        "explanation": "满足信息中介定位，无资金池，银行存管，无自担保，借款限额合规",
    },
    {
        "id": 2,
        "name": "速融网（模拟）",
        ...
        "features": {
            "资金托管": "平台自行管理（非银行存管）",
            "借款上限": "企业单平台借款上限500万元（超出规定300万元限额）",
            "出借人风险测评": "未做",
            "平台担保": "平台提供本金保障承诺",
            "资金池": "存在期限错配资金池",
            "信息披露": "仅每月披露一次",
        },
        "violations": ["未采用银行存管", "借款超额", "平台自担保", "资金池操作", "未做风险测评"],
        "verdict": "严重违规",
        "explanation": "五项核心违规：无银行存管、超借款限额、自担保、资金池、未做风险测评——属于典型非法集资风险平台",
    },
    {
        "id": 3,
        "name": "链信借（模拟）",
        "desc": "区块链抵押借贷平台，以数字资产作抵押",
        "features": {
            "资金托管": "银行存管",
            "借款上限": "自然人单平台20万元",
            "出借人风险测评": "已做",
        ...
        "violations": ["抵押物为虚拟货币（国内禁止以加密货币作为抵押）"],
        "verdict": "部分违规",
        "explanation": "基本合规，但以加密货币作为抵押物违反2021年禁令",
    },
]

# Part B：央行数字货币（e-CNY）场景判断
ECNY_SCENARIOS = [
    {
        "id": 1,
        "scenario": "某用户在无网络覆盖区域使用e-CNY硬钱包完成了一笔100元的超市支付",
        "question": "这笔交易是否符合e-CNY的设计特性？",
        "correct": "yes",
        "explanation": "e-CNY支持离线支付（NFC碰碰支付），这是其优于传统数字支付的核心功能之一",
    },
    {
        "id": 2,
        "scenario": "某平台宣称使用e-CNY可以完全匿名，交易记录不留存于任何机构",
        "question": "该宣传是否准确描述了e-CNY的隐私设计？",
        "correct": "no",
        "explanation": "e-CNY是'可控匿名'：对普通商户匿名，但央行具备最终溯源能力，并非完全匿名",
    },
    {
        "id": 3,
        "scenario": "某商业银行在未获央行授权的情况下，自行向公众兑换e-CNY",
        "question": "该行为是否合规？",
        "correct": "no",
        "explanation": "e-CNY采用双层运营：仅央行发行，授权商业银行（6大行+邮储等）向公众兑换，非授权银行不得自行兑换",
    },
    {
        "id": 4,
        "scenario": "e-CNY可以用于购买股票、基金等金融产品",
        "question": "该说法是否正确？",
        "correct": "yes",
        "explanation": "e-CNY与人民币等值，可用于合法的金融产品购买，已在部分证券账户开通充值功能",
    },
    {
        "id": 5,
        "scenario": "某境外企业持有在中国赚取的e-CNY，可以直接兑换成美元汇出境外",
        "question": "e-CNY是否突破了中国的外汇管制？",
        "correct": "no",
        "explanation": "e-CNY属于人民币，仍适用现行外汇管理法规，跨境使用须经外汇审批，不绕过资本账户管制",
    },
]

# Part C：监管科技（RegTech）工具匹配
REGTECH_TOOLS = [
    {
        "id": 1,
        "problem": "银行每天处理数百万笔交易，人工核查可疑交易效率极低",
        "correct_tool": "A",
        "tools": {
            "A": "机器学习AML（反洗钱）交易监控系统",
            "B": "区块链分布式账本",
            "C": "监管报送自动化平台",
            "D": "生物特征识别系统",
        },
        "explanation": "AML交易监控使用机器学习模型实时分析海量交易，识别异常模式，是反洗钱监管科技的核心应用",
    },
    {
        "id": 2,
        "problem": "保险公司每季度向监管机构报送偿付能力报告，数据准备耗时数周，错误率高",
        "correct_tool": "C",
        "tools": {
            "A": "机器学习风险预测模型",
            "B": "自然语言处理合规分析",
            "C": "监管报送自动化平台（RegReporting）",
            "D": "智能合约",
        },
        "explanation": "监管报送自动化平台（RegReporting）直接从系统抓取数据，按监管格式自动生成报告，减少人工干预和错误",
    },
    {
        "id": 3,
        "problem": "新出台的监管法规数量庞大，合规团队难以及时解读并评估对业务的影响",
        "correct_tool": "B",
        "tools": {
            "A": "区块链存证系统",
            "B": "NLP法规解读与合规影响分析工具",
        ...
        "explanation": "自然语言处理（NLP）可自动解析法规文本，提取关键要求，并映射至企业现有业务流程，输出合规差距分析报告",
    },
]
